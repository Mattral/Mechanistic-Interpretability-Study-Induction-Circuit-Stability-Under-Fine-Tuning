...
\textbf{Limitations of current results.} All fine-tuning results are from
seed 42 only. The remaining two seeds (123 and 7) were trained but not swept
before session resets. Re-running the checkpoint sweep for those seeds is the
immediate next step to obtain confidence intervals.
